...
import influxdb from '../../../../images/influxdblogo.png';
...
export const INFLUX_DB = 'influxdb';
export const INFLUXDB_URN = `urn:li:dataPlatform:${INFLUX_DB}`;
